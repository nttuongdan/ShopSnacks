					...
					<div class="row">
						...
						<div class="col-lg-12 col-12">
							<div class="text-center mb-5 pb-2">
								...
								<a href="#section_2" class="btn custom-btn smoothscroll mt-3">So
									Hot !!!!!!!!!</a>
							</div>

							<div class="owl-carousel owl-theme">
								<div class="owl-carousel-info-wrap item">
									<img src="homehead/images/profile/1.png"
										class="owl-carousel-image img-fluid" alt="">

									<div class="owl-carousel-info">
										<h7 class="mb-2"> Lay's vị nấm truffle <img
											src="homehead/images/verified.png"
								...
								<div class="owl-carousel-info-wrap item">
									<img src="homehead/images/profile/4.png"
										class="owl-carousel-image img-fluid" alt="">

									<div class="owl-carousel-info">
										<h7 class="mb-2"> Swing Snack maxx <img
											src="homehead/images/verified.png"
											class="owl-carousel-verified-image img-fluid" alt="">
										</h4>
									</div>
								...
								<div class="owl-carousel-info-wrap item">
									<img src="homehead/images/profile/3.png"
										class="owl-carousel-image img-fluid" alt="">

									<div class="owl-carousel-info">
										<h7 class="mb-2"> Snack Cheetos <img
											src="homehead/images/verified.png"
											class="owl-carousel-verified-image img-fluid" alt="">
										</h4>
									</div>
								...
								<div class="owl-carousel-info-wrap item">
									<img src="homehead/images/profile/2.png"
										class="owl-carousel-image img-fluid" alt="">

									<div class="owl-carousel-info">
										<h7 class="mb-2"> Lay's Vị tảo biển Nori <img
											src="homehead/images/verified.png"
											class="owl-carousel-verified-image img-fluid" alt="">
										</h4>
									</div>
								...
								<div class="owl-carousel-info-wrap item">
									<img src="homehead/images/profile/5.png"
										class="owl-carousel-image img-fluid" alt="">

									<div class="owl-carousel-info">
										<h7 class="mb-2"> Snack O'star <img
											src="homehead/images/verified.png"
											class="owl-carousel-verified-image img-fluid" alt="">
										</h4>
									</div>
								...
								<div class="owl-carousel-info-wrap item">
									<img src="homehead/images/profile/6.png"
										class="owl-carousel-image img-fluid" alt="">

									<div class="owl-carousel-info">
										<h7 class="mb-2"> Snack Poca vị bò lúc lắc <img
											src="homehead/images/verified.png"
											class="owl-carousel-verified-image img-fluid" alt="">
										</h4>
									</div>
								...
								<div class="owl-carousel-info-wrap item">
									<img src="homehead/images/profile/7.png"
										class="owl-carousel-image img-fluid" alt="">

									<div class="owl-carousel-info">
										<h7 class="mb-2"> Snack Oishi vị bắp ngọt <img
											src="homehead/images/verified.png"
											class="owl-carousel-verified-image img-fluid" alt="">
										</h4>
									</div>
								...
								<div class="owl-carousel-info-wrap item">
									<img src="homehead/images/profile/8.png"
										class="owl-carousel-image img-fluid" alt="">

									<div class="owl-carousel-info">
										<h7 class="mb-2"> Snack Mi <img
											src="homehead/images/verified.png"
											class="owl-carousel-verified-image img-fluid" alt="">
										</h4>
									</div>
