			...
			<div class="wrapper row">
				<div class="preview col-md-6">
					...
					<div class="preview-pic tab-content">
						<div class="tab-pane active border border-secondary" id="pic-1">
				...
				<div class="details col-md-6">
					...
					<form action="ThemGioHangMoTaAction" method="get">
						...
						<br>
						<div class="action">
							<button type="submit" class="add-to-cart btn btn-warning">
