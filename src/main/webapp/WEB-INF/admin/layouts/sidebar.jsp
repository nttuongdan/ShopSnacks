	...
	<div class="tab-content" id="setting-content">
		...
		<div class="tab-pane fade" id="chats-section" role="tabpanel"
			...
			<ul class="chat-list">
				...
				<li class="list">
					<div class="profile">
						<img src="../../assets/images/faces/face2.jpg" alt="image"><span
							class="offline"></span>
					</div>
					<div class="info">
				...
				<li class="list">
					<div class="profile">
						<img src="../../assets/images/faces/face3.jpg" alt="image"><span
							class="online"></span>
					</div>
					<div class="info">
						<p>Daniel Russell</p>
				...
				<li class="list">
					<div class="profile">
						<img src="../../assets/images/faces/face4.jpg" alt="image"><span
							class="offline"></span>
					</div>
					<div class="info">
				...
				<li class="list">
					<div class="profile">
						<img src="../../assets/images/faces/face5.jpg" alt="image"><span
							class="online"></span>
					</div>
					<div class="info">
				...
				<li class="list">
					<div class="profile">
						<img src="../../assets/images/faces/face6.jpg" alt="image"><span
							class="online"></span>
					</div>
					<div class="info">
						<p>Sarah Graves</p>
...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
	<ul class="nav">
		<li class="nav-item"><a class="nav-link" href="homeAdminAction">
		...
		<li class="nav-item"><a class="nav-link"
			href="listFoodAction">
				...
				class="menu-title">Danh sách sản phẩm</span>
		</a></li>
		<li class="nav-item nav-category">hóa đơn</li>
		<li class="nav-item"><a class="nav-link"
			href="listHoaDonAction">
				<i class="menu-icon mdi mdi-card-text-outline"></i> <span
				class="menu-title">Danh sách hóa đơn</span>
		</a></li>
